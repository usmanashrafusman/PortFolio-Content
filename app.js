...
function scroll() {
  ...
  let conditonAbout =
    currrentPosition >= aboutPos && currrentPosition < coursePos;
  about.classList.toggle("activediv", conditonAbout);

  let conditonCourse =
    currrentPosition >= coursePos && currrentPosition < teachersPos;
  course.classList.toggle("activediv", conditonCourse);

  let conditonTeacher =
    currrentPosition >= teachersPos && currrentPosition < activitiesPos;
  teacher.classList.toggle("activediv", conditonTeacher);

  let conditionActivities =
    currrentPosition >= activitiesPos && currrentPosition < pricesPos;
  activities.classList.toggle("activediv", conditionActivities);

  let conditionPrices =
    currrentPosition >= pricesPos && currrentPosition < contactPos;
